...
class LibraryFunctions:
    ...
    def addsession(self):
        ...
        with open('C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\books.txt','r') as booksLi:
            for books in str(booksLi).split('\n'):
                if book!=books and writer!=books:
                    file=open('C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\books.txt','a')
                    file.write(f"\n{book} by {writer} ({year})")
    ...
    def issuesession(self):
        ...
        allBooks=os.listdir('C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\Issued Books')
        ...
        for names in allBooks:
            if names==name:
                ...
                with open('C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\books.txt','r') as file:
                    for books in file:
                        if book not in books:
                            ...
                            newFile=open(f"C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\Issued Books\\{name}",'w')
    ...
    def delsession(self):
        ...
        path = "C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\Logs\\logs.txt"
        date = datetime.now()
        owo = open("C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\books.txt", "r+")
        fileData=owo.read()
    ...
    def returnsession(self):
        ...
        path ="C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\Returned Books"
        ...
        if self.borrower=='' or self.fine=='':
            ...
            with open(f"{path}/returned.txt",'a+') as file: 
                ...
                if borrower in os.listdir('C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\Issued Books'):
                    os.remove(f"C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\Issued Books\\{borrower}")
                    file.write(f'{index} : {borrower} Returned {book} \n Dated : {date}\n')
                    finefile = open('C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\fines.txt','a+')
    ...
    def showfines(self):
        ...
        owo.pack()
        with open('C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\Returned Books\\fines.txt','r') as file:
            for fines in file:
...
class BackEnd:
    ...
    def register(self):
        ...
        allAccounts= os.listdir("C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\Accounts")
        ...
        if cpwd==pwd:
            for i in allAccounts:
                if i == u_name:
                    ...
                    newFile=open(f"C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\Accounts\\{u_name}","w")
    ...
    def login(self):
        ...
        allAcc=os.listdir("C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\Accounts")
        ...
        try: 
            ...
            for names in allAcc:
                ...
                if names == u:
                    acc = open(f"C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\Accounts\\{names}",'r').read()
                    pwd = acc.split('\n')
                    pwd_from_list=pwd[5]
...
class LoginSys(BackEnd):
    ...
    def loginSession(self):
        ...
        self.photo = PhotoImage(file = "C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\title_icon.png")
...
class LibraryModels(LibraryFunctions,LoginSys,RegisterSys):
    ...
    def __init__(self,win,img):
        ...
        Label(self.mainWin,text='By: Prabin chettri' ,font="hack 10",bg='black',fg='blue').pack(pady=25)
    ...
    def IssueBooks(self):
        ...
        folder=os.listdir("C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\Issued Books")
    
        for file in range(len(folder)):
            self.li.append(open(f'C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\Issued Books\\{folder[file]}','r').read().split('\n'))
    ...
    def ReturnBooks(self):
        ...
        for details in open("C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\Returned Books\\returned.txt").read().split('\n'):
    ...
    def DeleteBooks(self):
        ...
        for logs in open("C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\Logs\\logs.txt").read().split('\n'):
...
Win = Tk()
img =  Image.open("C:\\Users\\rabin\\Desktop\\LMS-main\\LMS-main\\LMS\\uit.jpg")
